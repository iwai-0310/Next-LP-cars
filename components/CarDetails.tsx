      ...
      <Transition appear show={isOpen} as={Fragment}>
        ...
        <Dialog as="div" className="relative z-10" onClose={closeModal}>
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div
              className="flex min-h-full items
            ...
            >
              ...
              >
                ...
                >
                  ...
                  {/* section for car details starts */}
                  <div className="flex-1 flex flex-col gap-3 ">
                    ...
                    {/* section to contain three samll car images ends here */}
                  </div>
                  {/* section for car details ends */}

                  {/* car addtional content starts here */}
                  ...
                  {/* car additional content ends here*/}
                </Dialog.Panel>
              </Transition.Child>
            </div>
          </div>
